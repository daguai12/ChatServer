...
ChatService::ChatService()
{
  ...
  _msgHandlerMap.insert({ADD_GROUP_MSG,std::bind(&ChatService::createGroup,this, _1, _2,_3)});
  _msgHandlerMap.insert({GROUP_CHAT_MSG,std::bind(&ChatService::createGroup,this, _1, _2,_3)});
